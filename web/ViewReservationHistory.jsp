...
<%
    if (request.getSession().getAttribute("userID") == null) {
        ...
        if (request.getSession().getAttribute("hotelID") == null) {
            ...
            String x = request.getParameter("fromDate");
            String y = request.getParameter("toDate");
...
<html>
    ...
    <body>
        <ul>
            <li style="float:left"><a href="ReservationHistory.jsp">Back</a></li>
        ...
        <%                rs = stmt.executeQuery("select * from reservation where checkInDate between '" + x + "' and '" + y + "'and checkOutDate between '" + x + "' and '" + y + "' and Branch_branchID in (select branchID from branch where Hotel_hotelID = '" + hotelID + "')  ");
            while (rs.next()) {
        %>
        <tr class="bg-primary">
            ...
            <% String arr[] = rs.getString("checkInDate").split(" ");%>
