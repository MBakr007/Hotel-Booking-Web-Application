<%-- 
    ...
    Created on : Jan 17, 2021, 12:25:01 AM
    Author     : mbakr
--%>
...
<html>
    ...
    <body>
        ...
        <div style="max-width: 20rem; float: left; margin: 18px;">
            <form>
                <div class="card" style="width: 20rem; margin-left: 40px;">
                    <img class="card-img-top" src="<%=rs.getString("BranchImage")%>">
                    <div class="card-body">
                        <a class="ex2" href="room.jsp?branchID=<%=rs.getString("branchID")%>"><h5 class="card-title"><b><%=rs.getString("hotelName")%>, <%=rs.getString("location")%></b></h5></a>
